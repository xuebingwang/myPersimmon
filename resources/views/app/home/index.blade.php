    ...
    <script>
        ...
        $(document).on('click','#shuzizhengshu', function () {
            $.modal({
                ...
                '<p>数字证书是由借山画馆和市文化教育局组织承办由猫眼艺术传播体验馆提供。线上VR猫眼艺术馆体验场景，让美的灵魂伤口快速传播到亿万用户中去，让普通用户"走进艺术，走进生活"，让艺术家办个展更容易，让艺术美离我们更近。</p>' +
        ...
        function show_cooperate_apply() {
            $.modal({
                ...
                text: '' +
                '<div style="font-size: 12px;text-align: left; background: rgb(220,220,220); border-radius: .35rem; padding: .2rem;">' +
                '<p>欢迎关注画品画，猫眼艺术是一家VR艺术传播教育体验服务商，免费为艺术家和少儿美术培训机构提供VR艺术展、艺术直播、艺术教育学习，提供用户在线看展、学习、在线购买伤口。</p>' +
