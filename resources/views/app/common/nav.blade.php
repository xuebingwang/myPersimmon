...
var banzhan_tip = '备注：办展申请1-2个工作日通过后，需提交至少10副作品才可办展，作品高清手机拍照图片1920x1080分辨率即可。\n' +
    '            如需通过我方平台在线交易，需签署授权协议由我方统一制作版画销售按每副作品10-15%税后分成，作品城另提交高清数码照片或扫描图片300DPI值。';
function show_apply() {
    $.modal({
        title:  '免费办展申请',
        text: '' +
        '<div style="font-size: 12px;text-align: left; background: rgb(220,220,220); border-radius: .35rem; padding: .2rem;">' +
        '<p>猫眼艺术传播体验馆致力于国家艺术文化大战略，倡导艺术文化走进生活、走进大众，以艺术传播教育为己任，将艺术美从儿童抓起。通过线上VR猫眼艺术馆体验场景，让美的灵魂作品快速传播到亿万用户中去，让普通用户"走进艺术，走进生活"，让艺术家办个展更容易，让艺术美离我们更近。</p>' +
        '<p>新申请会员享有30天免费体验期，体验期满后想继续使用需充值使用（100元/30天，300元/90天，600元/180天，1200元/560天），申请认证付费会员享有每年30天免费体验。同时展览将永久保留，您可以随时随地开展，分享您的亲朋好友展示您的才华，让您的粉丝零距离和您交流。</p>' +
